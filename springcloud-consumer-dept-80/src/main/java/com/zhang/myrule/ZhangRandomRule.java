...
public class ZhangRandomRule extends AbstractLoadBalancerRule {
    ...
    // 每个机器访问5次，换下一个服务（只有三个服务，所以要有归零操作）
    // total=0, 默认为0， 如果=5，指向下一个服务节点
    // index=0， 默认0，如果total=5，index++, total=0；如果index>3, index=0
...
//                server = (Server)upList.get(index);              // 在活着的服务中找到这个随机数对应的服务
